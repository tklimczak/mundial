...
export const createInitialGroups = (): GroupItem[] => {
...
export const createRandomGroups = (): GroupItem[] => {
  let initialGroup: GroupItem[] = [];

  let codes = countries.map((x) => x.countryCode);

  var arr: number[] = [];
  while (arr.length < 32) {
    var r = Math.floor(Math.random() * codes.length) + 1;
